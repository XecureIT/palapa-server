...
public class TwilioSmsSender implements ISmsSender {
  ...
  public TwilioSmsSender(String baseUri, TwilioConfiguration twilioConfiguration) {
    this(baseUri, twilioConfiguration, new SmsVerificationConfiguration());
  }

  public TwilioSmsSender(String baseUri, TwilioConfiguration twilioConfiguration, SmsVerificationConfiguration smsVerificationConfiguration) {
  ...
  public TwilioSmsSender(TwilioConfiguration twilioConfiguration, SmsVerificationConfiguration smsVerificationConfiguration) {
      this("https://api.twilio.com", twilioConfiguration, smsVerificationConfiguration);
  }
  ...
  public CompletableFuture<Boolean> deliverSmsVerification(String destination, Optional<String> clientType, String verificationCode) {
    ...
    if ("ios".equals(clientType.orElse(null))) {
      requestParameters.put("Body", String.format(smsVerificationConfiguration.getSmsIOSVerificationText(), verificationCode));
    } else if ("android-ng".equals(clientType.orElse(null))) {
      requestParameters.put("Body", String.format(smsVerificationConfiguration.getSmsAndroidNGVerificationText(), verificationCode));
    } else {
      requestParameters.put("Body", String.format(smsVerificationConfiguration.getSmsVerificationText(), verificationCode));
    }
