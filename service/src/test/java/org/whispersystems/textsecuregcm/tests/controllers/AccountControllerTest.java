...
public class AccountControllerTest {
  ...
  private ControlPanelConfiguration     controlPanel           = mock(ControlPanelConfiguration.class);
  ...
  public void testGetApnPreauth() throws Exception {
    ...
    assertThat(captor.getValue().getData().isPresent()).isTrue();
    assertThat(captor.getValue().getData().get().length()).isEqualTo(32);
    assertThat(captor.getValue().getMessage()).contains("\"challenge\" : \"" + captor.getValue().getData().get() + "\"");
  ...
  public void testCreateAccount() throws Exception {
    Response response =
            resources.getJerseyTest()
                    .target(String.format("/v1/accounts/cp/code/%s", SENDER))
                    .request()
                    .header("Authorization", "Basic ZmQxMjQ4MTAtYzhlNi00N2FhLWFhYTYtM2IwMzc2NWE3Zjk0OnRnakc5U0hneE1mcGFLUnJVdVRTc0hrN3Y2Y1A2OEtFdVhIVGFxVm4=")
                    .get();
